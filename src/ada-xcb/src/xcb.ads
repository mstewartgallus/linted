...
package XCB with
   ...
   pragma Convention
     (C_Pass_By_Copy,
      xcb_generic_reply_t);  -- /usr/include/xcb/xcb.h:130

   type xcb_generic_event_t_pad_array is
     array (0 .. 6) of aliased Libc.Stdint.uint32_t;
   type xcb_generic_event_t is record
      response_type : aliased Libc.Stdint
        .uint8_t;  -- /usr/include/xcb/xcb.h:138
      ...
      full_sequence : aliased Libc.Stdint
        .uint32_t;  -- /usr/include/xcb/xcb.h:142
   end record;
   pragma Convention
     (C_Pass_By_Copy,
      xcb_generic_event_t);  -- /usr/include/xcb/xcb.h:143

   type xcb_ge_event_t_pad_array is
     array (0 .. 4) of aliased Libc.Stdint.uint32_t;
   type xcb_ge_event_t is record
      response_type : aliased Libc.Stdint
        .uint8_t;  -- /usr/include/xcb/xcb.h:155
      ...
      full_sequence : aliased Libc.Stdint
        .uint32_t;  -- /usr/include/xcb/xcb.h:162
   end record;
   pragma Convention
     (C_Pass_By_Copy,
      xcb_ge_event_t);  -- /usr/include/xcb/xcb.h:163

   type xcb_generic_error_t_pad_array is
     array (0 .. 4) of aliased Libc.Stdint.uint32_t;
   type xcb_generic_error_t is record
      response_type : aliased Libc.Stdint
        .uint8_t;  -- /usr/include/xcb/xcb.h:171
      ...
      resource_id : aliased Libc.Stdint
        .uint32_t;  -- /usr/include/xcb/xcb.h:174
      ...
      full_sequence : aliased Libc.Stdint
        .uint32_t;  -- /usr/include/xcb/xcb.h:179
   end record;
   pragma Convention
     (C_Pass_By_Copy,
      xcb_generic_error_t);  -- /usr/include/xcb/xcb.h:180
   ...
   pragma Convention
     (C_Pass_By_Copy,
      xcb_void_cookie_t);  -- /usr/include/xcb/xcb.h:189
   ...
   pragma Convention
     (C_Pass_By_Copy,
      xcb_auth_info_t);  -- /usr/include/xcb/xcb.h:216

   function xcb_flush
     (c : xcb_connection_t_access) return int;  -- /usr/include/xcb/xcb.h:234
   pragma Import (C, xcb_flush, "xcb_flush");

   function xcb_get_maximum_request_length
     (c : xcb_connection_t_access)
     return Libc.Stdint.uint32_t;  -- /usr/include/xcb/xcb.h:251
   pragma Import
     (C,
   ...
   procedure xcb_prefetch_maximum_request_length
     (c : xcb_connection_t_access);  -- /usr/include/xcb/xcb.h:270
   pragma Import
     (C,
   ...
   function xcb_wait_for_event
     (c : xcb_connection_t_access)
     return access xcb_generic_event_t;  -- /usr/include/xcb/xcb.h:284
   pragma Import (C, xcb_wait_for_event, "xcb_wait_for_event");

   function xcb_poll_for_event
     (c : xcb_connection_t_access)
     return access xcb_generic_event_t;  -- /usr/include/xcb/xcb.h:297
   pragma Import (C, xcb_poll_for_event, "xcb_poll_for_event");

   function xcb_poll_for_queued_event
     (c : xcb_connection_t_access)
     return access xcb_generic_event_t;  -- /usr/include/xcb/xcb.h:313
   ...
   function xcb_poll_for_special_event
     (c : xcb_connection_t_access;
      se : xcb_special_event_t)
     return access xcb_generic_event_t;  -- /usr/include/xcb/xcb.h:320
   pragma Import (C, xcb_poll_for_special_event, "xcb_poll_for_special_event");

   function xcb_wait_for_special_event
     (c : xcb_connection_t_access;
      se : xcb_special_event_t)
     return access xcb_generic_event_t;  -- /usr/include/xcb/xcb.h:326
   ...
   function xcb_register_for_special_xge
     (c : xcb_connection_t_access;
      ...
      stamp : access Libc.Stdint.uint32_t)
     return xcb_special_event_t_access;  -- /usr/include/xcb/xcb.h:337
   pragma Import
     (C,
   ...
   procedure xcb_unregister_for_special_event
     (c : xcb_connection_t_access;
      se : xcb_special_event_t);  -- /usr/include/xcb/xcb.h:345
   pragma Import
     (C,
   ...
   function xcb_get_setup
     (c : xcb_connection_t_access)
      return access constant XCB.XProto
       .xcb_setup_t;  -- /usr/include/xcb/xcb.h:437
   pragma Import (C, xcb_get_setup, "xcb_get_setup");

   function xcb_get_file_descriptor
     (c : xcb_connection_t_access) return int;  -- /usr/include/xcb/xcb.h:447
   pragma Import (C, xcb_get_file_descriptor, "xcb_get_file_descriptor");

   function xcb_connection_has_error
     (c : xcb_connection_t_access) return int;  -- /usr/include/xcb/xcb.h:466
   pragma Import (C, xcb_connection_has_error, "xcb_connection_has_error");

   function xcb_connect_to_fd
     (fd : int;
      auth_info : access xcb_auth_info_t)
     return xcb_connection_t_access;  -- /usr/include/xcb/xcb.h:480
   pragma Import (C, xcb_connect_to_fd, "xcb_connect_to_fd");

   procedure xcb_disconnect
     (c : xcb_connection_t_access);  -- /usr/include/xcb/xcb.h:489
   ...
   function xcb_connect
     (displayname : Interfaces.C.Strings.chars_ptr;
      screenp : access int)
     return xcb_connection_t_access;  -- /usr/include/xcb/xcb.h:525
   ...
   function xcb_connect_to_display_with_auth_info
     (display : Interfaces.C.Strings.chars_ptr;
      ...
      screen : access int)
     return xcb_connection_t_access;  -- /usr/include/xcb/xcb.h:539
   pragma Import
     (C,
   ...
   function xcb_generate_id
     (c : xcb_connection_t_access)
     return Libc.Stdint.uint32_t;  -- /usr/include/xcb/xcb.h:552
   pragma Import (C, xcb_generate_id, "xcb_generate_id");
private
   type xcb_connection_t is limited record
      null;
   end record;
   type xcb_special_event_t is limited record
      null;
   end record;
   type xcb_extension_t is limited record
      null;
   end record;
end XCB;
