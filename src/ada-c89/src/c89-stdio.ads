...
package C89.Stdio is
   ...
   --  subtype off_t is C89.Sys.Types.uu_off_t;  -- /usr/include/stdio.h:90
   --  subtype off64_t is C89.Sys.Types.uu_off64_t;  -- /usr/include/stdio.h:97

   --  subtype ssize_t is C89.Sys.Types.uu_ssize_t;  -- /usr/include/stdio.h:102

   --  subtype fpos_t is C89.uG_config_h.u_G_fpos_t;
   --  subtype fpos64_t is C89.uG_config_h.u_G_fpos64_t;
   ...
   --     uu_modes : Interfaces.C.Strings.chars_ptr;
   --     uu_io_funcs : C89.libio_h.u_IO_cookie_io_functions_t) return access FILE;  -- /usr/include/stdio.h:312
   --  pragma Import (C, fopencookie, "fopencookie");

   function fmemopen
     (uu_s : System.Address;
      uu_len : C89.Stddef.size_t;
      uu_modes : Interfaces.C.Strings.chars_ptr) return access FILE;  -- /usr/include/stdio.h:319
   pragma Import (C, fmemopen, "fmemopen");

   function open_memstream (uu_bufloc : System.Address; uu_sizeloc : access C89.Stddef.size_t) return access FILE;  -- /usr/include/stdio.h:325
   ...
   function setvbuf
     (uu_stream : access FILE;
      ...
      uu_modes : int;
      uu_n : C89.Stddef.size_t) return int;  -- /usr/include/stdio.h:336
   pragma Import (C, setvbuf, "setvbuf");

   procedure setbuffer
     (uu_stream : access FILE;
      uu_buf : Interfaces.C.Strings.chars_ptr;
      uu_size : C89.Stddef.size_t);  -- /usr/include/stdio.h:343
   ...
   --     uu_n : access C89.Stddef.size_t;
   --     uu_delimiter : int;
   --     uu_stream : access FILE) return C89.Sys.Types.uu_ssize_t;  -- /usr/include/stdio.h:668
   --  pragma Import (C, getdelim, "getdelim");

   --  function getline
   --    (uu_lineptr : System.Address;
   --     uu_n : access C89.Stddef.size_t;
   --     uu_stream : access FILE) return C89.Sys.Types.uu_ssize_t;  -- /usr/include/stdio.h:678
   ...
   function fread
     (uu_ptr : System.Address;
      uu_size : C89.Stddef.size_t;
      uu_n : C89.Stddef.size_t;
      uu_stream : access FILE) return C89.Stddef.size_t;  -- /usr/include/stdio.h:709
   ...
   function fwrite
     (uu_ptr : System.Address;
      uu_size : C89.Stddef.size_t;
      uu_n : C89.Stddef.size_t;
      uu_s : access FILE) return C89.Stddef.size_t;  -- /usr/include/stdio.h:715
   ...
   function fread_unlocked
     (uu_ptr : System.Address;
      uu_size : C89.Stddef.size_t;
      uu_n : C89.Stddef.size_t;
      uu_stream : access FILE) return C89.Stddef.size_t;  -- /usr/include/stdio.h:737
   ...
   function fwrite_unlocked
     (uu_ptr : System.Address;
      uu_size : C89.Stddef.size_t;
      uu_n : C89.Stddef.size_t;
      uu_stream : access FILE) return C89.Stddef.size_t;  -- /usr/include/stdio.h:739
   ...
   --  function fseeko
   --    (uu_stream : access FILE;
   --     uu_off : C89.Sys.Types.uu_off_t;
   --     uu_whence : int) return int;  -- /usr/include/stdio.h:773
   --  pragma Import (C, fseeko, "fseeko");

   --  function ftello (uu_stream : access FILE) return C89.Sys.Types.uu_off_t;  -- /usr/include/stdio.h:778
   ...
   --  function fseeko64
   --    (uu_stream : access FILE;
   --     uu_off : C89.Sys.Types.uu_off64_t;
   --     uu_whence : int) return int;  -- /usr/include/stdio.h:818
   --  pragma Import (C, fseeko64, "fseeko64");

   --  function ftello64 (uu_stream : access FILE) return C89.Sys.Types.uu_off64_t;  -- /usr/include/stdio.h:819
   ...
   --  function fsetpos64 (uu_stream : access FILE; uu_pos : access fpos64_t) return int;  -- /usr/include/stdio.h:821
