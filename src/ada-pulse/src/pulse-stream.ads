...
package Pulse.Stream is
   ...
   --  skipped empty struct pa_stream
   ...
   function pa_stream_new
     (c : System.Address;
      ...
      map : access constant Pulse.Channelmap.pa_channel_map) return System.Address;  -- /usr/include/pulse/stream.h:344
   ...
   function pa_stream_new_with_proplist
     (c : System.Address;
      ...
      p : System.Address) return System.Address;  -- /usr/include/pulse/stream.h:353
   ...
   function pa_stream_new_extended
     (c : System.Address;
      ...
      n_formats : unsigned;
      p : System.Address) return System.Address;  -- /usr/include/pulse/stream.h:364
   pragma Import (C, pa_stream_new_extended, "pa_stream_new_extended");

   procedure pa_stream_unref (s : System.Address);  -- /usr/include/pulse/stream.h:372
   pragma Import (C, pa_stream_unref, "pa_stream_unref");

   function pa_stream_ref (s : System.Address) return System.Address;  -- /usr/include/pulse/stream.h:375
   pragma Import (C, pa_stream_ref, "pa_stream_ref");

   function pa_stream_get_state (p : System.Address) return Pulse.Def.pa_stream_state_t;  -- /usr/include/pulse/stream.h:378
   pragma Import (C, pa_stream_get_state, "pa_stream_get_state");

   function pa_stream_get_context (p : System.Address) return System.Address;  -- /usr/include/pulse/stream.h:381
   pragma Import (C, pa_stream_get_context, "pa_stream_get_context");

   function pa_stream_get_index (s : System.Address) return Libc.Stdint.uint32_t;  -- /usr/include/pulse/stream.h:387
   pragma Import (C, pa_stream_get_index, "pa_stream_get_index");

   function pa_stream_get_device_index (s : System.Address) return Libc.Stdint.uint32_t;  -- /usr/include/pulse/stream.h:398
   pragma Import (C, pa_stream_get_device_index, "pa_stream_get_device_index");

   function pa_stream_get_device_name (s : System.Address) return Interfaces.C.Strings.chars_ptr;  -- /usr/include/pulse/stream.h:409
   pragma Import (C, pa_stream_get_device_name, "pa_stream_get_device_name");

   function pa_stream_is_suspended (s : System.Address) return int;  -- /usr/include/pulse/stream.h:415
   pragma Import (C, pa_stream_is_suspended, "pa_stream_is_suspended");

   function pa_stream_is_corked (s : System.Address) return int;  -- /usr/include/pulse/stream.h:419
   ...
   function pa_stream_disconnect (s : System.Address) return int;  -- /usr/include/pulse/stream.h:455
   ...
   function pa_stream_cancel_write (p : System.Address) return int;  -- /usr/include/pulse/stream.h:503
   ...
   function pa_stream_drop (p : System.Address) return int;  -- /usr/include/pulse/stream.h:559
   pragma Import (C, pa_stream_drop, "pa_stream_drop");

   function pa_stream_writable_size (p : System.Address) return Libc.Stddef.size_t;  -- /usr/include/pulse/stream.h:562
   pragma Import (C, pa_stream_writable_size, "pa_stream_writable_size");

   function pa_stream_readable_size (p : System.Address) return Libc.Stddef.size_t;  -- /usr/include/pulse/stream.h:565
   ...
   function pa_stream_get_underflow_index (p : System.Address) return Libc.Stdint.int64_t;  -- /usr/include/pulse/stream.h:596
   ...
   function pa_stream_get_time (s : System.Address; r_usec : access Pulse.Sample.pa_usec_t) return int;  -- /usr/include/pulse/stream.h:702
   ...
   function pa_stream_get_timing_info (s : System.Address) return access constant Pulse.Def.pa_timing_info;  -- /usr/include/pulse/stream.h:732
   pragma Import (C, pa_stream_get_timing_info, "pa_stream_get_timing_info");

   function pa_stream_get_sample_spec (s : System.Address) return access constant Pulse.Sample.pa_sample_spec;  -- /usr/include/pulse/stream.h:735
   pragma Import (C, pa_stream_get_sample_spec, "pa_stream_get_sample_spec");

   function pa_stream_get_channel_map (s : System.Address) return access constant Pulse.Channelmap.pa_channel_map;  -- /usr/include/pulse/stream.h:738
   pragma Import (C, pa_stream_get_channel_map, "pa_stream_get_channel_map");

   function pa_stream_get_format_info (s : System.Address) return access constant Pulse.Format.pa_format_info;  -- /usr/include/pulse/stream.h:741
   pragma Import (C, pa_stream_get_format_info, "pa_stream_get_format_info");

   function pa_stream_get_buffer_attr (s : System.Address) return access constant Pulse.Def.pa_buffer_attr;  -- /usr/include/pulse/stream.h:751
   ...
   function pa_stream_set_monitor_stream (s : System.Address; sink_input_idx : Libc.Stdint.uint32_t) return int;  -- /usr/include/pulse/stream.h:786
   pragma Import (C, pa_stream_set_monitor_stream, "pa_stream_set_monitor_stream");

   function pa_stream_get_monitor_stream (s : System.Address) return Libc.Stdint.uint32_t;  -- /usr/include/pulse/stream.h:791
