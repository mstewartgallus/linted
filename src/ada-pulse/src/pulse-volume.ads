...
package Pulse.Volume with SPARK_Mode => Off is
   ...
   type pa_cvolume is record
      channels : aliased Libc.Stdint.uint8_t;  -- /usr/include/pulse/volume.h:136
   ...
   function pa_cvolume_snprint
     (s : Interfaces.C.Strings.chars_ptr;
      ...
      c : System.Address) return Interfaces.C.Strings.chars_ptr;  -- /usr/include/pulse/volume.h:165
   pragma Import (C, pa_cvolume_snprint, "pa_cvolume_snprint");

   function pa_sw_cvolume_snprint_dB
     (s : Interfaces.C.Strings.chars_ptr;
      l : Libc.Stddef.size_t;
      c : System.Address) return Interfaces.C.Strings.chars_ptr;  -- /usr/include/pulse/volume.h:175
   pragma Import (C, pa_sw_cvolume_snprint_dB, "pa_sw_cvolume_snprint_dB");

   function pa_volume_snprint
     (s : Interfaces.C.Strings.chars_ptr;
      l : Libc.Stddef.size_t;
      v : pa_volume_t) return Interfaces.C.Strings.chars_ptr;  -- /usr/include/pulse/volume.h:185
   pragma Import (C, pa_volume_snprint, "pa_volume_snprint");

   function pa_sw_volume_snprint_dB
     (s : Interfaces.C.Strings.chars_ptr;
      l : Libc.Stddef.size_t;
      v : pa_volume_t) return Interfaces.C.Strings.chars_ptr;  -- /usr/include/pulse/volume.h:195
   pragma Import (C, pa_sw_volume_snprint_dB, "pa_sw_volume_snprint_dB");

   function pa_cvolume_avg (a : System.Address) return pa_volume_t;  -- /usr/include/pulse/volume.h:198
   ...
   function pa_cvolume_avg_mask
     (a : System.Address;
      ...
      mask : Pulse.Channelmap.pa_channel_position_mask_t) return pa_volume_t;  -- /usr/include/pulse/volume.h:205
   pragma Import (C, pa_cvolume_avg_mask, "pa_cvolume_avg_mask");

   function pa_cvolume_max (a : System.Address) return pa_volume_t;  -- /usr/include/pulse/volume.h:208
   pragma Import (C, pa_cvolume_max, "pa_cvolume_max");

   function pa_cvolume_max_mask
     (a : System.Address;
      cm : access constant Pulse.Channelmap.pa_channel_map;
      mask : Pulse.Channelmap.pa_channel_position_mask_t) return pa_volume_t;  -- /usr/include/pulse/volume.h:215
   pragma Import (C, pa_cvolume_max_mask, "pa_cvolume_max_mask");

   function pa_cvolume_min (a : System.Address) return pa_volume_t;  -- /usr/include/pulse/volume.h:218
   ...
   function pa_sw_cvolume_multiply
     (dest : access pa_cvolume;
      a : System.Address;
      b : System.Address) return access pa_cvolume;  -- /usr/include/pulse/volume.h:247
   pragma Import (C, pa_sw_cvolume_multiply, "pa_sw_cvolume_multiply");

   function pa_sw_cvolume_multiply_scalar
     (dest : access pa_cvolume;
      a : System.Address;
      b : pa_volume_t) return access pa_cvolume;  -- /usr/include/pulse/volume.h:253
   pragma Import (C, pa_sw_cvolume_multiply_scalar, "pa_sw_cvolume_multiply_scalar");

   function pa_sw_volume_divide (a : pa_volume_t; b : pa_volume_t) return pa_volume_t;  -- /usr/include/pulse/volume.h:259
   pragma Import (C, pa_sw_volume_divide, "pa_sw_volume_divide");

   function pa_sw_cvolume_divide
     (dest : access pa_cvolume;
      a : System.Address;
      b : System.Address) return access pa_cvolume;  -- /usr/include/pulse/volume.h:264
   ...
   function pa_cvolume_scale_mask
     (v : access pa_cvolume;
      ...
      mask : Pulse.Channelmap.pa_channel_position_mask_t) return access pa_cvolume;  -- /usr/include/pulse/volume.h:348
   ...
   function pa_cvolume_set_position
     (cv : access pa_cvolume;
      ...
      v : pa_volume_t) return access pa_cvolume;  -- /usr/include/pulse/volume.h:355
   pragma Import (C, pa_cvolume_set_position, "pa_cvolume_set_position");

   function pa_cvolume_get_position
     (cv : access pa_cvolume;
      map : access constant Pulse.Channelmap.pa_channel_map;
      t : Pulse.Channelmap.pa_channel_position_t) return pa_volume_t;  -- /usr/include/pulse/volume.h:361
   pragma Import (C, pa_cvolume_get_position, "pa_cvolume_get_position");

   function pa_cvolume_merge
     (dest : access pa_cvolume;
      a : System.Address;
      b : System.Address) return access pa_cvolume;  -- /usr/include/pulse/volume.h:366
   pragma Import (C, pa_cvolume_merge, "pa_cvolume_merge");

   function pa_cvolume_inc_clamp
     (v : access pa_cvolume;
      inc : pa_volume_t;
      limit : pa_volume_t) return access pa_cvolume;  -- /usr/include/pulse/volume.h:370
   pragma Import (C, pa_cvolume_inc_clamp, "pa_cvolume_inc_clamp");

   function pa_cvolume_inc (v : access pa_cvolume; inc : pa_volume_t) return access pa_cvolume;  -- /usr/include/pulse/volume.h:374
   pragma Import (C, pa_cvolume_inc, "pa_cvolume_inc");

   function pa_cvolume_dec (v : access pa_cvolume; dec : pa_volume_t) return access pa_cvolume;  -- /usr/include/pulse/volume.h:378
