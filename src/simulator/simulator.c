...
static void simulate_rotation(linted_updater_uint *rotation,
                              linted_updater_int tilt);
static void simulate_clamped_rotation(linted_updater_uint *rotation,
                                      linted_updater_int tilt);
                                      ...
                                      linted_updater_int tilt)
{
    ...
    linted_updater_uint new_rotation;
