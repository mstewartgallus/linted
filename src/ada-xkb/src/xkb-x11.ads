...
package XKB.X11 is
   ...
   function xkb_x11_setup_xkb_extension
     (connection : XCB.xcb_connection_t_access;
      ...
      base_error_out : access Libc.Stdint.uint8_t) return int;  -- /usr/include/xkbcommon/xkbcommon-x11.h:98
   pragma Import (C, xkb_x11_setup_xkb_extension, "xkb_x11_setup_xkb_extension");

   function xkb_x11_get_core_keyboard_device_id (connection : XCB.xcb_connection_t) return Libc.Stdint.int32_t;  -- /usr/include/xkbcommon/xkbcommon-x11.h:116
   ...
   function xkb_x11_keymap_new_from_device
     (context : XKB.xkb_context_access;
      ...
      flags : XKB.xkb_keymap_compile_flags) return XKB.xkb_keymap_access;  -- /usr/include/xkbcommon/xkbcommon-x11.h:140
   ...
   function xkb_x11_state_new_from_device
     (keymap : XKB.xkb_keymap_access;
      connection : XCB.xcb_connection_t_access;
      device_id : Libc.Stdint.int32_t) return  XKB.xkb_state_access;  -- /usr/include/xkbcommon/xkbcommon-x11.h:164
