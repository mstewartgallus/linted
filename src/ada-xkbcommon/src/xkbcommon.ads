...
with C89.Stddef;
with System;
limited with C89.Stdio;

package Xkbcommon is
   pragma Preelaborate;
   ...
   subtype xkb_keycode_t is C99.Stdint.uint32_t;  -- /usr/include/xkbcommon/xkbcommon.h:161

   subtype xkb_keysym_t is C99.Stdint.uint32_t;  -- /usr/include/xkbcommon/xkbcommon.h:191

   subtype xkb_layout_index_t is C99.Stdint.uint32_t;  -- /usr/include/xkbcommon/xkbcommon.h:211

   subtype xkb_layout_mask_t is C99.Stdint.uint32_t;  -- /usr/include/xkbcommon/xkbcommon.h:213

   subtype xkb_level_index_t is C99.Stdint.uint32_t;  -- /usr/include/xkbcommon/xkbcommon.h:227

   subtype xkb_mod_index_t is C99.Stdint.uint32_t;  -- /usr/include/xkbcommon/xkbcommon.h:252

   subtype xkb_mod_mask_t is C99.Stdint.uint32_t;  -- /usr/include/xkbcommon/xkbcommon.h:254

   subtype xkb_led_index_t is C99.Stdint.uint32_t;  -- /usr/include/xkbcommon/xkbcommon.h:281

   subtype xkb_led_mask_t is C99.Stdint.uint32_t;  -- /usr/include/xkbcommon/xkbcommon.h:283
   ...
   function xkb_keysym_get_name
     (keysym : xkb_keysym_t;
      ...
      size : C89.Stddef.size_t) return int;  -- /usr/include/xkbcommon/xkbcommon.h:393
   ...
   function xkb_keysym_to_utf8
     (keysym : xkb_keysym_t;
      buffer : Interfaces.C.Strings.chars_ptr;
      size : C89.Stddef.size_t) return int;  -- /usr/include/xkbcommon/xkbcommon.h:443
   pragma Import (C, xkb_keysym_to_utf8, "xkb_keysym_to_utf8");

   function xkb_keysym_to_utf32 (keysym : xkb_keysym_t) return C99.Stdint.uint32_t;  -- /usr/include/xkbcommon/xkbcommon.h:458
   ...
   function xkb_keymap_new_from_file
     (context : xkb_context_access;
      the_file : access C89.Stdio.FILE;
   ...
   function xkb_state_key_get_utf8
     (state : xkb_state_access;
      key : xkb_keycode_t;
      buffer : Interfaces.C.Strings.chars_ptr;
      size : C89.Stddef.size_t) return int;  -- /usr/include/xkbcommon/xkbcommon.h:1304
   pragma Import (C, xkb_state_key_get_utf8, "xkb_state_key_get_utf8");

   function xkb_state_key_get_utf32 (state : xkb_state_access; key : xkb_keycode_t) return C99.Stdint.uint32_t;  -- /usr/include/xkbcommon/xkbcommon.h:1317
