...
package Libc.Stdio.GNU with SPARK_Mode => Off is
   ...
   --     uu_modes : Interfaces.C.Strings.chars_ptr;
   --     uu_io_funcs : Libc.libio_h.u_IO_cookie_io_functions_t) return access FILE;  -- /usr/include/stdio.h:312
   ...
   --     uu_n : access size_t;
   --     uu_delimiter : int;
   --     uu_stream : access FILE) return Libc.Sys.Types.uu_ssize_t;  -- /usr/include/stdio.h:668
   ...
   function fread_unlocked
     (uu_ptr : System.Address;
      uu_size : size_t;
      uu_n : size_t;
      uu_stream : access FILE) return size_t;  -- /usr/include/stdio.h:737
   ...
   function fwrite_unlocked
     (uu_ptr : System.Address;
      uu_size : size_t;
      uu_n : size_t;
      uu_stream : access FILE) return size_t;  -- /usr/include/stdio.h:739
   ...
   --  function fseeko64
   --    (uu_stream : access FILE;
   --     uu_off : Libc.Sys.Types.uu_off64_t;
   --     uu_whence : int) return int;  -- /usr/include/stdio.h:818
   --  pragma Import (C, fseeko64, "fseeko64");

   --  function ftello64 (uu_stream : access FILE) return Libc.Sys.Types.uu_off64_t;  -- /usr/include/stdio.h:819
