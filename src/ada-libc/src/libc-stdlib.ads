...
package Libc.Stdlib with SPARK_Mode => Off is
   ...
   function atof (nptr : Interfaces.C.Strings.chars_ptr) return double;  -- /usr/include/stdlib.h:144
   pragma Import (C, atof, "atof");

   function atoi (nptr : Interfaces.C.Strings.chars_ptr) return int;  -- /usr/include/stdlib.h:147
   ...
   function strtof (nptr : Interfaces.C.Strings.chars_ptr; endptr : System.Address) return float;  -- /usr/include/stdlib.h:172
   pragma Import (C, strtof, "strtof");

   function strtold (nptr : Interfaces.C.Strings.chars_ptr; endptr : System.Address) return long_double;  -- /usr/include/stdlib.h:175
   ...
   function strtoull
     (nptr : Interfaces.C.Strings.chars_ptr;
      endptr : System.Address;
      base : int) return Extensions.unsigned_long_long;  -- /usr/include/stdlib.h:214
   ...
   function calloc (nmemb : size_t; size : size_t) return System.Address;  -- /usr/include/stdlib.h:468
   pragma Import (C, calloc, "calloc");

   procedure free (ptr : System.Address);  -- /usr/include/stdlib.h:483
   pragma Import (C, free, "free");

   function malloc (size : size_t) return System.Address;  -- /usr/include/stdlib.h:466
   pragma Import (C, malloc, "malloc");

   function realloc (ptr : System.Address; size : size_t) return System.Address;  -- /usr/include/stdlib.h:480
   pragma Import (C, realloc, "realloc");

   procedure c_abort;  -- /usr/include/stdlib.h:515
   pragma Import (C, c_abort, "abort");

   function atexit (func : access procedure) return int;  -- /usr/include/stdlib.h:519
   ...
   function getenv (name : Interfaces.C.Strings.chars_ptr) return Interfaces.C.Strings.chars_ptr;  -- /usr/include/stdlib.h:564
   pragma Import (C, getenv, "getenv");

   function c_system (command : Interfaces.C.Strings.chars_ptr) return int;  -- /usr/include/stdlib.h:717
   pragma Import (C, c_system, "system");

   type compar_fn_t is access function (arg1 : System.Address; arg2 : System.Address) return int;
   ...
   function bsearch
     (key : System.Address;
      ...
      nmemb : size_t;
      size : size_t;
      compar : compar_fn_t) return System.Address;  -- /usr/include/stdlib.h:755
   ...
   function wctomb (s : Interfaces.C.Strings.chars_ptr; wchar : wchar_t) return int;  -- /usr/include/stdlib.h:870
