...
package Libc.String is
   ...
   function memcpy
     (uu_dest : System.Address;
      ...
      uu_n : Libc.Stddef.size_t) return System.Address;  -- /usr/include/string.h:46
   ...
   function memmove
     (uu_dest : System.Address;
      uu_src : System.Address;
      uu_n : Libc.Stddef.size_t) return System.Address;  -- /usr/include/string.h:50
   ...
   function memccpy
     (uu_dest : System.Address;
      ...
      uu_n : Libc.Stddef.size_t) return System.Address;  -- /usr/include/string.h:58
   ...
   function memset
     (uu_s : System.Address;
      uu_c : Interfaces.C.int;
      uu_n : Libc.Stddef.size_t) return System.Address;  -- /usr/include/string.h:66
   ...
   function memcmp
     (uu_s1 : System.Address;
      ...
      uu_n : Libc.Stddef.size_t) return Interfaces.C.int;  -- /usr/include/string.h:69
   ...
   function memchr
     (uu_s : System.Address;
      uu_c : Interfaces.C.int;
      uu_n : Libc.Stddef.size_t) return System.Address;  -- /usr/include/string.h:76
   pragma Import (C, memchr, "memchr");

   -- Search in S for C.  This is similar to `memchr' but there is no
   --   length limit.

   function rawmemchr (uu_s : System.Address; uu_c : Interfaces.C.int) return System.Address;  -- /usr/include/string.h:105
   ...
   function memrchr
     (uu_s : System.Address;
      uu_c : Interfaces.C.int;
      uu_n : Libc.Stddef.size_t) return System.Address;  -- /usr/include/string.h:116
   ...
   function strncpy
     (uu_dest : Interfaces.C.Strings.chars_ptr;
      ...
      uu_n : Libc.Stddef.size_t) return Interfaces.C.Strings.chars_ptr;  -- /usr/include/string.h:132
   ...
   function strncat
     (uu_dest : Interfaces.C.Strings.chars_ptr;
      uu_src : Interfaces.C.Strings.chars_ptr;
      uu_n : Libc.Stddef.size_t) return Interfaces.C.Strings.chars_ptr;  -- /usr/include/string.h:140
   pragma Import (C, strncat, "strncat");

   -- Compare S1 and S2.
   function strcmp (uu_s1 : Interfaces.C.Strings.chars_ptr; uu_s2 : Interfaces.C.Strings.chars_ptr) return Interfaces.C.int;  -- /usr/include/string.h:144
   ...
   function strncmp
     (uu_s1 : Interfaces.C.Strings.chars_ptr;
      ...
      uu_n : Libc.Stddef.size_t) return Interfaces.C.int;  -- /usr/include/string.h:147
   pragma Import (C, strncmp, "strncmp");

   -- Compare the collated forms of S1 and S2.
   function strcoll (uu_s1 : Interfaces.C.Strings.chars_ptr; uu_s2 : Interfaces.C.Strings.chars_ptr) return Interfaces.C.int;  -- /usr/include/string.h:151
   ...
   function strxfrm
     (uu_dest : Interfaces.C.Strings.chars_ptr;
      uu_src : Interfaces.C.Strings.chars_ptr;
      uu_n : Libc.Stddef.size_t) return Libc.Stddef.size_t;  -- /usr/include/string.h:154
   ...
   function strndup (uu_string : Interfaces.C.Strings.chars_ptr; uu_n : Libc.Stddef.size_t) return Interfaces.C.Strings.chars_ptr;  -- /usr/include/string.h:184
   pragma Import (C, strndup, "strndup");

   -- Duplicate S, returning an identical alloca'd string.
   -- Return an alloca'd copy of at most N bytes of string.
   -- Find the first occurrence of C in S.
   function strchr (uu_s : Interfaces.C.Strings.chars_ptr; uu_c : Interfaces.C.int) return Interfaces.C.Strings.chars_ptr;  -- /usr/include/string.h:216
   pragma Import (C, strchr, "strchr");

   -- Find the last occurrence of C in S.
   function strrchr (uu_s : Interfaces.C.Strings.chars_ptr; uu_c : Interfaces.C.int) return Interfaces.C.Strings.chars_ptr;  -- /usr/include/string.h:243
   pragma Import (C, strrchr, "strrchr");

   -- This function is similar to `strchr'.  But it returns a pointer to
   --   the closing NUL byte in case C is not found in S.

   function strchrnul (uu_s : Interfaces.C.Strings.chars_ptr; uu_c : Interfaces.C.int) return Interfaces.C.Strings.chars_ptr;  -- /usr/include/string.h:272
   pragma Import (C, strchrnul, "strchrnul");

   -- Return the length of the initial segment of S which
   --   consists entirely of characters not in REJECT.

   function strcspn (uu_s : Interfaces.C.Strings.chars_ptr; uu_reject : Interfaces.C.Strings.chars_ptr) return Libc.Stddef.size_t;  -- /usr/include/string.h:285
   pragma Import (C, strcspn, "strcspn");

   -- Return the length of the initial segment of S which
   --   consists entirely of characters in ACCEPT.

   function strspn (uu_s : Interfaces.C.Strings.chars_ptr; uu_accept : Interfaces.C.Strings.chars_ptr) return Libc.Stddef.size_t;  -- /usr/include/string.h:289
   ...
   function memmem
     (uu_haystack : System.Address;
      ...
      uu_needlelen : Libc.Stddef.size_t) return System.Address;  -- /usr/include/string.h:382
   ...
   function mempcpy
     (uu_dest : System.Address;
      uu_src : System.Address;
      uu_n : Libc.Stddef.size_t) return System.Address;  -- /usr/include/string.h:391
   pragma Import (C, mempcpy, "mempcpy");

   -- Return the length of S.
   function strlen (uu_s : Interfaces.C.Strings.chars_ptr) return Libc.Stddef.size_t;  -- /usr/include/string.h:399
   pragma Import (C, strlen, "strlen");

   -- Find the length of STRING, but scan at most MAXLEN characters.
   --   If no '\0' terminator is found in that many characters, return MAXLEN.

   function strnlen (uu_string : Interfaces.C.Strings.chars_ptr; uu_maxlen : Libc.Stddef.size_t) return Libc.Stddef.size_t;  -- /usr/include/string.h:406
   pragma Import (C, strnlen, "strnlen");

   -- Return a string describing the meaning of the `errno' code in ERRNUM.
   function strerror (uu_errnum : Interfaces.C.int) return Interfaces.C.Strings.chars_ptr;  -- /usr/include/string.h:413
   ...
   procedure bzero (uu_s : System.Address; uu_n : Libc.Stddef.size_t);  -- /usr/include/string.h:459
   ...
   function bcmp
     (uu_s1 : System.Address;
      uu_s2 : System.Address;
      uu_n : Libc.Stddef.size_t) return Interfaces.C.int;  -- /usr/include/string.h:462
   pragma Import (C, bcmp, "bcmp");

   -- Find the first occurrence of C in S (same as strchr).
   function index (uu_s : Interfaces.C.Strings.chars_ptr; uu_c : Interfaces.C.int) return Interfaces.C.Strings.chars_ptr;  -- /usr/include/string.h:469
   pragma Import (C, index, "index");

   -- Find the last occurrence of C in S (same as strrchr).
   function rindex (uu_s : Interfaces.C.Strings.chars_ptr; uu_c : Interfaces.C.int) return Interfaces.C.Strings.chars_ptr;  -- /usr/include/string.h:497
   pragma Import (C, rindex, "rindex");

   -- Return the position of the first bit set in I, or 0 if none are set.
   --   The least-significant bit is position 1, the most-significant 32.

   function ffs (uu_i : Interfaces.C.int) return Interfaces.C.int;  -- /usr/include/string.h:523
   pragma Import (C, ffs, "ffs");

   -- The following two functions are non-standard but necessary for non-32 bit
   --   platforms.

   function ffsl (uu_l : Interfaces.C.long) return Interfaces.C.int;  -- /usr/include/string.h:528
   ...
   function strcasecmp (uu_s1 : Interfaces.C.Strings.chars_ptr; uu_s2 : Interfaces.C.Strings.chars_ptr) return Interfaces.C.int;  -- /usr/include/string.h:534
   ...
   function strncasecmp
     (uu_s1 : Interfaces.C.Strings.chars_ptr;
      uu_s2 : Interfaces.C.Strings.chars_ptr;
      uu_n : Libc.Stddef.size_t) return Interfaces.C.int;  -- /usr/include/string.h:538
   ...
   function strsignal (uu_sig : Interfaces.C.int) return Interfaces.C.Strings.chars_ptr;  -- /usr/include/string.h:564
   ...
   function stpncpy
     (uu_dest : Interfaces.C.Strings.chars_ptr;
      uu_src : Interfaces.C.Strings.chars_ptr;
      uu_n : Libc.Stddef.size_t) return Interfaces.C.Strings.chars_ptr;  -- /usr/include/string.h:577
   pragma Import (C, stpncpy, "stpncpy");

   -- Compare S1 and S2 as strings holding name & indices/version numbers.
   function strverscmp (uu_s1 : Interfaces.C.Strings.chars_ptr; uu_s2 : Interfaces.C.Strings.chars_ptr) return Interfaces.C.int;  -- /usr/include/string.h:584
   ...
   function memfrob (uu_s : System.Address; uu_n : Libc.Stddef.size_t) return System.Address;  -- /usr/include/string.h:591
