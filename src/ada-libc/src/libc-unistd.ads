...
package Libc.Unistd with
   ...
   function lseek
     (fd : int;
      ...
      whence : int) return Libc.Sys.Types.off_t;  -- /usr/include/unistd.h:334
   ...
   function chown
     (file : Interfaces.C.Strings.chars_ptr;
      ...
      group : Libc.Sys.Types.gid_t) return int;  -- /usr/include/unistd.h:473
   pragma Import (C, chown, "chown");

   function fchown
     (fd : int;
      owner : Libc.Sys.Types.uid_t;
      group : Libc.Sys.Types.gid_t) return int;  -- /usr/include/unistd.h:478
   pragma Import (C, fchown, "fchown");

   function lchown
     (file : Interfaces.C.Strings.chars_ptr;
      owner : Libc.Sys.Types.uid_t;
      group : Libc.Sys.Types.gid_t) return int;  -- /usr/include/unistd.h:483
   ...
   function setresuid
     (ruid : Libc.Sys.Types.uid_t;
      ...
      suid : Libc.Sys.Types.uid_t) return int;  -- /usr/include/unistd.h:743
   pragma Import (C, setresuid, "setresuid");

   function setresgid
     (rgid : Libc.Sys.Types.gid_t;
      egid : Libc.Sys.Types.gid_t;
      sgid : Libc.Sys.Types.gid_t) return int;  -- /usr/include/unistd.h:748
   ...
   function ttyname_r
     (fd : int;
      buf : Interfaces.C.Strings.chars_ptr;
      buflen : size_t) return int;  -- /usr/include/unistd.h:774
   ...
   function lockf
     (fd : int;
      cmd : int;
      len : Libc.Sys.Types.off_t) return int;  -- /usr/include/unistd.h:1081
   pragma Import (C, lockf, "lockf");

   function lockf64
     (fd : int;
      cmd : int;
      len : Libc.Sys.Types.off64_t) return int;  -- /usr/include/unistd.h:1091
   ...
   procedure swab
     (from : System.Address;
      to : System.Address;
      n : Libc.Sys.Types.ssize_t);  -- /usr/include/unistd.h:1133
