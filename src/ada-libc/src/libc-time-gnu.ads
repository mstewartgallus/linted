...
package Libc.Time.GNU with SPARK_Mode => Off is
   ...
   function strptime
     (s : Interfaces.C.Strings.chars_ptr;
      ...
      tp : access tm) return Interfaces.C.Strings.chars_ptr;  -- /usr/include/time.h:213
   ...
   function strftime_l
     (s : Interfaces.C.Strings.chars_ptr;
      ...
      loc : Libc.Locale.GNU.locale_t) return size_t;  -- /usr/include/time.h:223
   ...
   function strptime_l
     (s : Interfaces.C.Strings.chars_ptr;
      fmt : Interfaces.C.Strings.chars_ptr;
      tp : access tm;
      loc : Libc.Locale.GNU.locale_t) return Interfaces.C.Strings.chars_ptr;  -- /usr/include/time.h:230
   pragma Import (C, strptime_l, "strptime_l");

   function gmtime_r (timer : access time_t; tp : access tm) return access tm;  -- /usr/include/time.h:249
   pragma Import (C, gmtime_r, "gmtime_r");

   function localtime_r (timer : access time_t; tp : access tm) return access tm;  -- /usr/include/time.h:254
   pragma Import (C, localtime_r, "localtime_r");

   function asctime_r (tp : access constant tm; buf : Interfaces.C.Strings.chars_ptr) return Interfaces.C.Strings.chars_ptr;  -- /usr/include/time.h:272
   pragma Import (C, asctime_r, "asctime_r");

   function ctime_r (timer : access time_t; buf : Interfaces.C.Strings.chars_ptr) return Interfaces.C.Strings.chars_ptr;  -- /usr/include/time.h:276
   ...
   function stime (c_when : access time_t) return int;  -- /usr/include/time.h:304
   ...
   function timelocal (tp : access tm) return time_t;  -- /usr/include/time.h:322
   ...
   function nanosleep (requested_time : access constant timespec; remaining : access timespec) return int;  -- /usr/include/time.h:334
   pragma Import (C, nanosleep, "nanosleep");

   function clock_getres (clock_id : clockid_t; res : access timespec) return int;  -- /usr/include/time.h:339
   pragma Import (C, clock_getres, "clock_getres");

   function clock_gettime (clock_id : clockid_t; tp : access timespec) return int;  -- /usr/include/time.h:342
   pragma Import (C, clock_gettime, "clock_gettime");

   function clock_settime (clock_id : clockid_t; tp : access constant timespec) return int;  -- /usr/include/time.h:345
   ...
   function clock_getcpuclockid (pid : Libc.Sys.Types.pid_t; clock_id : access clockid_t) return int;  -- /usr/include/time.h:358
   ...
   function timer_delete (timerid : timer_t) return int;  -- /usr/include/time.h:368
   ...
   function timer_gettime (timerid : timer_t; value : access itimerspec) return int;  -- /usr/include/time.h:376
   pragma Import (C, timer_gettime, "timer_gettime");

   function timer_getoverrun (timerid : timer_t) return int;  -- /usr/include/time.h:380
   pragma Import (C, timer_getoverrun, "timer_getoverrun");

   function timespec_get (ts : access timespec; base : int) return int;  -- /usr/include/time.h:386
   ...
   function getdate (string : Interfaces.C.Strings.chars_ptr) return access tm;  -- /usr/include/time.h:412
   pragma Import (C, getdate, "getdate");

   function getdate_r (string : Interfaces.C.Strings.chars_ptr; resbufp : access tm) return int;  -- /usr/include/time.h:426
