...
package Unix.Unistd is
   ...
   function faccessat
     (fd : int;
      ...
      c_type : int;
      flag : int) return int;  -- /usr/include/unistd.h:304
   pragma Import (C, faccessat, "faccessat");

   function lseek
     (fd : int;
      offset : Unix.Sys.Types.off_t;
      whence : int) return Unix.Sys.Types.off_t;  -- /usr/include/unistd.h:334
   pragma Import (C, lseek, "lseek");

   function lseek64
     (fd : int;
      offset : Unix.Sys.Types.off64_t;
      whence : int) return Unix.Sys.Types.off64_t;  -- /usr/include/unistd.h:345
   ...
   function read
     (fd : int;
      buf : System.Address;
      nbytes : C89.Stddef.size_t) return Unix.Sys.Types.ssize_t;  -- /usr/include/unistd.h:360
   pragma Import (C, read, "read");

   function write
     (fd : int;
      buf : System.Address;
      n : C89.Stddef.size_t) return Unix.Sys.Types.ssize_t;  -- /usr/include/unistd.h:366
   pragma Import (C, write, "write");

   function pread
     (fd : int;
      buf : System.Address;
      nbytes : C89.Stddef.size_t;
      offset : Unix.Sys.Types.off_t) return Unix.Sys.Types.ssize_t;  -- /usr/include/unistd.h:376
   ...
   function pwrite
     (fd : int;
      buf : System.Address;
      n : C89.Stddef.size_t;
      offset : Unix.Sys.Types.off_t) return Unix.Sys.Types.ssize_t;  -- /usr/include/unistd.h:384
   ...
   function pread64
     (fd : int;
      buf : System.Address;
      nbytes : C89.Stddef.size_t;
      offset : Unix.Sys.Types.off64_t) return Unix.Sys.Types.ssize_t;  -- /usr/include/unistd.h:404
   ...
   function pwrite64
     (fd : int;
      buf : System.Address;
      n : C89.Stddef.size_t;
      offset : Unix.Sys.Types.off64_t) return Unix.Sys.Types.ssize_t;  -- /usr/include/unistd.h:408
   ...
   function ualarm (value : Unix.Sys.Types.useconds_t; interval : Unix.Sys.Types.useconds_t) return Unix.Sys.Types.useconds_t;  -- /usr/include/unistd.h:452
   pragma Import (C, ualarm, "ualarm");

   function usleep (useconds : Unix.Sys.Types.useconds_t) return int;  -- /usr/include/unistd.h:460
   ...
   function chown
     (file : Interfaces.C.Strings.chars_ptr;
      owner : Unix.Sys.Types.uid_t;
      group : Unix.Sys.Types.gid_t) return int;  -- /usr/include/unistd.h:473
   pragma Import (C, chown, "chown");

   function fchown
     (fd : int;
      owner : Unix.Sys.Types.uid_t;
      group : Unix.Sys.Types.gid_t) return int;  -- /usr/include/unistd.h:478
   pragma Import (C, fchown, "fchown");

   function lchown
     (file : Interfaces.C.Strings.chars_ptr;
      owner : Unix.Sys.Types.uid_t;
      group : Unix.Sys.Types.gid_t) return int;  -- /usr/include/unistd.h:483
   ...
   function getcwd (buf : Interfaces.C.Strings.chars_ptr; size : C89.Stddef.size_t) return Interfaces.C.Strings.chars_ptr;  -- /usr/include/unistd.h:511
   ...
   function dup3
     (fd : int;
      fd2 : int;
      flags : int) return int;  -- /usr/include/unistd.h:539
   ...
   function execve
     (path : Interfaces.C.Strings.chars_ptr;
      argv : System.Address;
      envp : System.Address) return int;  -- /usr/include/unistd.h:551
   ...
   function execvpe
     (file : Interfaces.C.Strings.chars_ptr;
      argv : System.Address;
      envp : System.Address) return int;  -- /usr/include/unistd.h:590
   pragma Import (C, execvpe, "execvpe");

   function nice (inc : int) return int;  -- /usr/include/unistd.h:598
   ...
   function confstr
     (name : int;
      ...
      len : C89.Stddef.size_t) return C89.Stddef.size_t;  -- /usr/include/unistd.h:623
   pragma Import (C, confstr, "confstr");

   function getpid return Unix.Sys.Types.pid_t;  -- /usr/include/unistd.h:628
   pragma Import (C, getpid, "getpid");

   function getppid return Unix.Sys.Types.pid_t;  -- /usr/include/unistd.h:631
   pragma Import (C, getppid, "getppid");

   function getpgrp return Unix.Sys.Types.pid_t;  -- /usr/include/unistd.h:634
   pragma Import (C, getpgrp, "getpgrp");

   function getpgid (pid : Unix.Sys.Types.pid_t) return Unix.Sys.Types.pid_t;  -- /usr/include/unistd.h:639
   pragma Import (C, getpgid, "getpgid");

   function setpgid (pid : Unix.Sys.Types.pid_t; pgid : Unix.Sys.Types.pid_t) return int;  -- /usr/include/unistd.h:646
   pragma Import (C, setpgid, "setpgid");

   function setpgrp return int;  -- /usr/include/unistd.h:660
   pragma Import (C, setpgrp, "setpgrp");

   function setsid return Unix.Sys.Types.pid_t;  -- /usr/include/unistd.h:667
   pragma Import (C, setsid, "setsid");

   function getsid (pid : Unix.Sys.Types.pid_t) return Unix.Sys.Types.pid_t;  -- /usr/include/unistd.h:671
   pragma Import (C, getsid, "getsid");

   function getuid return Unix.Sys.Types.uid_t;  -- /usr/include/unistd.h:675
   pragma Import (C, getuid, "getuid");

   function geteuid return Unix.Sys.Types.uid_t;  -- /usr/include/unistd.h:678
   pragma Import (C, geteuid, "geteuid");

   function getgid return Unix.Sys.Types.gid_t;  -- /usr/include/unistd.h:681
   pragma Import (C, getgid, "getgid");

   function getegid return Unix.Sys.Types.gid_t;  -- /usr/include/unistd.h:684
   pragma Import (C, getegid, "getegid");

   function getgroups (size : int; list : access Unix.Sys.Types.gid_t) return int;  -- /usr/include/unistd.h:689
   pragma Import (C, getgroups, "getgroups");

   function group_member (gid : Unix.Sys.Types.gid_t) return int;  -- /usr/include/unistd.h:693
   pragma Import (C, group_member, "group_member");

   function setuid (uid : Unix.Sys.Types.uid_t) return int;  -- /usr/include/unistd.h:700
   pragma Import (C, setuid, "setuid");

   function setreuid (ruid : Unix.Sys.Types.uid_t; euid : Unix.Sys.Types.uid_t) return int;  -- /usr/include/unistd.h:705
   pragma Import (C, setreuid, "setreuid");

   function seteuid (uid : Unix.Sys.Types.uid_t) return int;  -- /usr/include/unistd.h:710
   pragma Import (C, seteuid, "seteuid");

   function setgid (gid : Unix.Sys.Types.gid_t) return int;  -- /usr/include/unistd.h:717
   pragma Import (C, setgid, "setgid");

   function setregid (rgid : Unix.Sys.Types.gid_t; egid : Unix.Sys.Types.gid_t) return int;  -- /usr/include/unistd.h:722
   pragma Import (C, setregid, "setregid");

   function setegid (gid : Unix.Sys.Types.gid_t) return int;  -- /usr/include/unistd.h:727
   pragma Import (C, setegid, "setegid");

   function getresuid
     (ruid : access Unix.Sys.Types.uid_t;
      euid : access Unix.Sys.Types.uid_t;
      suid : access Unix.Sys.Types.uid_t) return int;  -- /usr/include/unistd.h:733
   pragma Import (C, getresuid, "getresuid");

   function getresgid
     (rgid : access Unix.Sys.Types.gid_t;
      egid : access Unix.Sys.Types.gid_t;
      sgid : access Unix.Sys.Types.gid_t) return int;  -- /usr/include/unistd.h:738
   pragma Import (C, getresgid, "getresgid");

   function setresuid
     (ruid : Unix.Sys.Types.uid_t;
      euid : Unix.Sys.Types.uid_t;
      suid : Unix.Sys.Types.uid_t) return int;  -- /usr/include/unistd.h:743
   pragma Import (C, setresuid, "setresuid");

   function setresgid
     (rgid : Unix.Sys.Types.gid_t;
      egid : Unix.Sys.Types.gid_t;
      sgid : Unix.Sys.Types.gid_t) return int;  -- /usr/include/unistd.h:748
   pragma Import (C, setresgid, "setresgid");

   function fork return Unix.Sys.Types.pid_t;  -- /usr/include/unistd.h:756
   pragma Import (C, fork, "fork");

   function vfork return Unix.Sys.Types.pid_t;  -- /usr/include/unistd.h:764
   ...
   function ttyname_r
     (fd : int;
      buf : Interfaces.C.Strings.chars_ptr;
      buflen : C89.Stddef.size_t) return int;  -- /usr/include/unistd.h:774
   pragma Import (C, ttyname_r, "ttyname_r");

   function isatty (fd : int) return int;  -- /usr/include/unistd.h:779
   ...
   function readlink
     (path : Interfaces.C.Strings.chars_ptr;
      buf : Interfaces.C.Strings.chars_ptr;
      len : C89.Stddef.size_t) return Unix.Sys.Types.ssize_t;  -- /usr/include/unistd.h:809
   ...
   function readlinkat
     (fd : int;
      path : Interfaces.C.Strings.chars_ptr;
      buf : Interfaces.C.Strings.chars_ptr;
      len : C89.Stddef.size_t) return Unix.Sys.Types.ssize_t;  -- /usr/include/unistd.h:820
   ...
   function tcgetpgrp (fd : int) return Unix.Sys.Types.pid_t;  -- /usr/include/unistd.h:839
   pragma Import (C, tcgetpgrp, "tcgetpgrp");

   function tcsetpgrp (fd : int; pgrp_id : Unix.Sys.Types.pid_t) return int;  -- /usr/include/unistd.h:842
   ...
   function getlogin_r (name : Interfaces.C.Strings.chars_ptr; name_len : C89.Stddef.size_t) return int;  -- /usr/include/unistd.h:857
   ...
   function gethostname (name : Interfaces.C.Strings.chars_ptr; len : C89.Stddef.size_t) return int;  -- /usr/include/unistd.h:879
   pragma Import (C, gethostname, "gethostname");

   function sethostname (name : Interfaces.C.Strings.chars_ptr; len : C89.Stddef.size_t) return int;  -- /usr/include/unistd.h:886
   ...
   function getdomainname (name : Interfaces.C.Strings.chars_ptr; len : C89.Stddef.size_t) return int;  -- /usr/include/unistd.h:897
   pragma Import (C, getdomainname, "getdomainname");

   function setdomainname (name : Interfaces.C.Strings.chars_ptr; len : C89.Stddef.size_t) return int;  -- /usr/include/unistd.h:899
   ...
   function profil
     (sample_buffer : access unsigned_short;
      size : C89.Stddef.size_t;
      offset : C89.Stddef.size_t;
   ...
   function syncfs (fd : int) return int;  -- /usr/include/unistd.h:962
   ...
   function truncate (file : Interfaces.C.Strings.chars_ptr; length : Unix.Sys.Types.off_t) return int;  -- /usr/include/unistd.h:993
   pragma Import (C, truncate, "truncate");

   function truncate64 (file : Interfaces.C.Strings.chars_ptr; length : Unix.Sys.Types.off64_t) return int;  -- /usr/include/unistd.h:1005
   pragma Import (C, truncate64, "truncate64");

   function ftruncate (fd : int; length : Unix.Sys.Types.off_t) return int;  -- /usr/include/unistd.h:1016
   pragma Import (C, ftruncate, "ftruncate");

   function ftruncate64 (fd : int; length : Unix.Sys.Types.off64_t) return int;  -- /usr/include/unistd.h:1026
   ...
   function sbrk (c_delta : C99.Stdint.intptr_t) return System.Address;  -- /usr/include/unistd.h:1043
   ...
   function lockf
     (fd : int;
      cmd : int;
      len : Unix.Sys.Types.off_t) return int;  -- /usr/include/unistd.h:1081
   pragma Import (C, lockf, "lockf");

   function lockf64
     (fd : int;
      cmd : int;
      len : Unix.Sys.Types.off64_t) return int;  -- /usr/include/unistd.h:1091
   ...
   procedure swab
     (from : System.Address;
      to : System.Address;
      n : Unix.Sys.Types.ssize_t);  -- /usr/include/unistd.h:1133
